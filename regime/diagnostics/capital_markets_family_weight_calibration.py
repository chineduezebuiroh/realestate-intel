...
def build(artifacts: dict[str,pd.DataFrame], root: Path) -> dict[str,pd.DataFrame]:
    ...
    governance=pd.DataFrame([{"recommendation_state":"none","promotion_state":"blocked_pending_corrected_rerun","human_decision":"invalidated_by_spread_polarity_defect","automated_winner":False,"production_policy_changed":False,"feature_weight_policy_changed":False,"metric_weight_policy_changed":False,"Demand_changed":False,"Supply_changed":False,"Capital_Markets_changed":False,"native_feature_calibration":"spread_10y_2y_revalidation_required","family_metric_weight_calibration":"invalidated_pending_rerun","candidate_grid_closed":True,"candidate_grid":"F0-F9","intra_family_metric_weight_calibration":"not_started","supply_s8_changed":False}])
