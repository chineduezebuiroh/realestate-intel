...
def build_inventory_calibration_campaign(
    *,
    ...
    campaign = CalibrationCampaign(
        ...
        target_axis="supply",
        primary_decomposition_axes=("supply",),
...
def run_phase_a_foundation_evidence(
    *, campaign_id: str, campaign_version: str, artifact_root: str | Path,
    ...
    if persist_system_evidence:
        ...
        selected = list(campaign.metadata["geography_scope"]["included_geo_ids"])
...
def persist_phase_a_foundation_evidence(
    ...
    try:
        ...
        validate_engine_decomposition(EngineDecompositionEvidence(
            ...
            evidence.campaign.supporting_coordinate_axes,
            evidence.decomposition_evidence.approved_geo_ids,
        ))
...
def load_phase_a_foundation_evidence(
    *, campaign_id: str, campaign_version: str, artifact_root: str | Path,
    ...
    decomposition = EngineDecompositionEvidence(campaign.campaign_id, campaign.campaign_version,
        ...
        tuple(campaign.metadata.get("geography_scope", {}).get("included_geo_ids", ())))
