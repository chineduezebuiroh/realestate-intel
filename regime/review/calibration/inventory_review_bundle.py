...
def build_inventory_review_bundle(
    *, campaign: CalibrationCampaign, phase_a_evidence: PhaseAEvidence,
    ...
    if (decomposition_evidence.campaign_id, decomposition_evidence.campaign_version,
            decomposition_evidence.candidate_policy_ids) != (
...
<h3>2.4 Challenger Completeness and Unaffected Parity</h3><p>Inventory branch recomputed. Capital Markets held constant. Demand held constant. Supply axis recomputed. Coordinates/regimes recomputed. The mixed dimension universe combines challenger Supply with exact persisted incumbent non-Supply dimensions; it does not claim that Capital Markets was reproduced from current upstream code.</p>{completeness_html}
