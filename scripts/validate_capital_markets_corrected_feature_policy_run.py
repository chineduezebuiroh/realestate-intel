#!/usr/bin/env python3
"""Fail-closed validator for the corrected Capital Markets P6 production run."""
...
RUN="capital_markets_feature_policy_corrected_production_20260818"
EXPERIMENT="capital_markets_feature_policy_corrected_production"
BASELINE="capital_markets_spread_polarity_repair_20260818"
...
def main():
 ...
 expected={"promotion_contract":"capital_markets_spread_10y_2y_p6_2026_08_18","corrected_spread_polarity":True,"human_decision":"spread_10y_2y_p6_approved","automated_winner":False,"family_metric_weight_calibration":"pending_rerun"}
 assert {m:md.get(f"{m}_feature_policy") for m in POLICIES}==POLICIES
 ...
 unchanged_other_cm=same(metrics[metrics.canonical_metric_key.isin(UNCHANGED_CM)],base_metrics[base_metrics.canonical_metric_key.isin(UNCHANGED_CM)],["geo_id","date","canonical_metric_key"])
 ...
 print(json.dumps({"manifest_status":"complete","artifact_hashes":"verified",**parity,**behavior,"unchanged_source_rows":unchanged_source,"unchanged_feature_rows":unchanged_features,"unchanged_normalized_rows":unchanged_normalized,"unchanged_metric_rows":unchanged_metrics,"other_five_capital_markets_metric_rows_unchanged":unchanged_other_cm,"non_capital_markets_metric_rows_unchanged":unchanged_non_cm,"metric_rows_rebuilt":metric_rows,"dimension_rows_rebuilt":dim_rows,"demand_supply_rows_rebuilt":axis_rows,"coordinate_rows_rebuilt":coordinate_rows,"geometry_rows_rebuilt":geometry_rows,"regime_rows_rebuilt":regime_rows,"family_metric_weight_calibration":"pending_rerun"},sort_keys=True))
