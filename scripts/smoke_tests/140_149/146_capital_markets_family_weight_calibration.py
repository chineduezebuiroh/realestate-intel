...
def main():
    assert DEFAULT_RUN==AUTHORITATIVE_RUN==Path("artifacts/regime/runs/capital_markets_feature_policy_production_20260818")
    ...
    assert NATIVE_POLICIES=={"mortgage_30y":"P4","mortgage_15y":"P2","treasury_10y":"P1","fedfunds":"P5","spread_10y_2y":"P7","spread_10y_fedfunds":"P9"}
    ...
    try: load_run(Path("/absent/capital_markets_feature_policy_production_20260818"))
