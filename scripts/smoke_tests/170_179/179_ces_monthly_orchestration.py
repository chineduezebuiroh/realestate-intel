...
assert set(workflow['jobs']['barrier']['needs'])=={'resolve-cycle','redfin','fred','ces'}
...
text=Path('jobs/monthly_refresh/cohort.py').read_text(); assert '("redfin", "fred_macro", "ces")' in text
