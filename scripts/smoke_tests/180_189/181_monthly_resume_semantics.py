...
expected_run=["bea_gdp_ann","bea_gdp_qtr","census_acs1","census_acs5","census_bps","census_bps_provisional","census_nrc"]
...
fred_failed=without("fred_macro"); assert fred_failed["reuse"]==["ces","laus","redfin"] and fred_failed["run"]==["bea_gdp_ann","bea_gdp_qtr","census_acs1","census_acs5","census_bps","census_bps_provisional","census_nrc","fred_macro"]
ces_failed=without("ces"); assert ces_failed["reuse"]==["fred_macro","laus","redfin"] and ces_failed["run"]==["bea_gdp_ann","bea_gdp_qtr","census_acs1","census_acs5","census_bps","census_bps_provisional","census_nrc","ces"]
...
assert missing["reuse"]==["ces","laus","redfin"] and missing["run"]==["bea_gdp_ann","bea_gdp_qtr","census_acs1","census_acs5","census_bps","census_bps_provisional","census_nrc","fred_macro"]
...
assert replay_plan["reuse"]==[] and replay_plan["run"]==["redfin","fred_macro","ces","laus","census_bps","census_bps_provisional","census_acs1","census_acs5","bea_gdp_qtr","bea_gdp_ann","census_nrc"]
...
assert "RESUME_FRED" in barrier_run["env"] and "RESUME_CES" in barrier_run["env"] and "RESUME_LAUS" in barrier_run["env"]
