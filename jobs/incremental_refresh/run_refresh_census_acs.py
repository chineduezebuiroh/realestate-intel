...
# jobs/incremental_refresh/run_refresh_census_acs.py
...
def main() -> int:
    ...
    print_context("refresh_census_acs_incremental", env_overrides=env)
    ...
    print("[job] refresh_census_acs_incremental complete")
    return 0
